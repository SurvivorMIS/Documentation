...
<table style="float:left;">
	<tr>
		<td colspan=2>Register at Reception</td>
	</tr>
	<tr>
		<td colspan=2>Start Visit: Cursory Survivor Needs Assessment</td>
	</tr>
	<tr>
		<td colspan=2>Decision Point: Encounter with Legal or Shelter team members</td>
	</tr>
	<tr>
		<td></td>
		<td></td>
